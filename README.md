# bip.dev OpenAPI Specification
[![Build Status](https://travis-ci.com/MinterTeam/bipdev-docs.svg?branch=master)](https://travis-ci.com/MinterTeam/bipdev-docs)
## Steps to finish
...
- [Reference Documentation (ReDoc)](https://minterteam.github.io/bipdev-docs/)
- OpenAPI Raw Files: [JSON](https://minterteam.github.io/bipdev-docs/openapi.json) [YAML](https://minterteam.github.io/bipdev-docs/openapi.yaml)
